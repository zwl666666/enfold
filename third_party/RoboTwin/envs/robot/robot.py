...
class Robot:
    ...
    def reset(self, scene, need_topp=False, **kwargs):
        ...
        if self.communication_flag:
            ...
            # Planner construction can fail part way through (for example, when
            # Curobo runs out of CUDA memory).  In that case a later episode
            # reset must rebuild it instead of masking the original failure

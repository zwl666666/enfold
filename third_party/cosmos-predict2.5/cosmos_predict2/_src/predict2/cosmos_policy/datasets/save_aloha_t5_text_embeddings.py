...
Usage:
    uv run -m cosmos_predict2._src.predict2.cosmos_policy.datasets.save_aloha_t5_text_embeddings [--data_dir DATA_DIR]
"""
...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="/lustre/fsw/portfolios/dir/users/user/data/aloha",

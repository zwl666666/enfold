...
def search_dataset_stats_cache_json(cache_dir: str | Path, data_config: DictConfig) -> Tuple[bool, str | None]:
    ...
    def normalize_use_relative_joint_action(cfg: DictConfig) -> bool:
        processor_cfg = cfg.get("processor")
        if processor_cfg is None:
            return False
        return bool(processor_cfg.get("use_relative_joint_action", False))
    ...
    signature = {
        ...
        "use_relative_joint_action": normalize_use_relative_joint_action(data_config),
    }
